...
def build_parser():
    ...
    #create a subparser for the reconstruct command
    reconstruct_parser = sub_parsers.add_parser("reconstruct", help="Reconstruct market data from downloaded files")
